// src/pages/Form.jsx  (o src/components/Form.jsx)
import React, { useEffect, useState } from "react";
import "./styles/GlobalConnectionForm.css"; // opcional, pero recomendable

const LOCAL_STORAGE_KEY = "lm_saved_firms";

const GlobalConnectionForm = () => {
        ...
        <div className="form-page">
            <div className="form-card">
                <header className="form-header">
                    <h1>Formulario de interés</h1>
                    <p className="form-subtitle">
                        Cuéntanos un poco más sobre tus intereses. Usaremos esta información
                        junto con las firmas que guardaste en tu lista.
                    </p>
                ...
                <form className="form-body" onSubmit={handleSubmit}>
                    ...
                    <div className="form-section">
                        <p className="form-section-title">
                            ¿En qué temas estás más interesado/a?
                        </p>
                    ...
                    {submitSuccess && (
                        <div className="form-alert form-alert-success">
                            ¡Gracias! Tu información se envió correctamente.
                        </div>
                    )}
...
export default GlobalConnectionForm;
